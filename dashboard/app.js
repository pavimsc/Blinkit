...
function renderValidation(data) {
  ...
  const rows = [
    ...
    [
      "Manual spot-check — overall agreement",
  ...
  if (v.agreement_pct != null) {
    rows.push(
      ["Spot-check — category agreement", `${v.category_agreement_pct}%`],
      ["Spot-check — sentiment agreement", `${v.sentiment_agreement_pct}%`],
    );
  }
